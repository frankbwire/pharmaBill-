...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 13, 2019 at 12:51 PM
...
(1, 'N-3333333', 'SN-23465', 'ANAESTHETICS', 'Milli', '5', '80', '400'),
...
(1, 'N-25220', 'Stallion GT', 'Driver', '77777777', '66666666', 'Male');
...
('N-25220', 'patient', 'middle', 'last', 'patient@email.com', '98754367', '34125688', 56, '2019-09-18', 'Male', 'Nairobi', '56 Ave.', '2019-06-13 10:31:39');
...
--
ALTER TABLE `drug_purchase`
  ADD CONSTRAINT `drug_purchase_ibfk_1` FOREIGN KEY (`bill_number`) REFERENCES `patient_billing` (`bill_number`);
