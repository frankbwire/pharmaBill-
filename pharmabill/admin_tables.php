      ...
      <div class="row">
        <div class="col-lg-4 col-md-4">
          <div class="single-feature">
            <a href="admin_patients.php" class="title">
        ...
        <div class="col-lg-4 col-md-4">
          <div class="single-feature">
            <a href="admin_medicine.php" class="title">
              <h3><b>Medicine Records</b></h3>
            </a>
        ...
        <div class="col-lg-4 col-md-4">
          <div class="single-feature">
            <a href="admin_purchase.php" class="title">
              <h3><b>Purchase Records</b></h3>
            </a>
