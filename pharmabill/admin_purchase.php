...
<body>
  ...
  <section class="offer_area">
    <div class="container">
        <h3 class="text-uppercase mb-40" style="font-weight: bold">Purchase Records</h3>
          <hr>
      <div class="row" style="padding-top:20px; padding-bottom:20px" style="max-height: 400px; overflow-y: auto; border: 1px solid #ccc;">
          ...
          <?php
               $sql = "SELECT  bill_number, med_category, med_name, med_quantity, med_price, total FROM drug_purchase ORDER BY bill_number DESC";
