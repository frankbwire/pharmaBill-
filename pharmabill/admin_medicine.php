...
<body>
  ...
  <section class="offer_area">
    <div class="container">
        <h3 class="text-uppercase mb-40" style="font-weight: bold">Medicine Records</h3>
          <hr>
      <div class="row" style="padding-top:20px; padding-bottom:20px" style="max-height: 400px; overflow-y: auto; border: 1px solid #ccc;">
          ...
          <?php
               $sql = "SELECT  medCategory, medName, dose_form, date_added FROM medicine ORDER BY date_added DESC";
          ...
          <tr>
            <td id="pid">
              <?php echo $rows['medCategory']; ?>
            </td>
            <td id="pid">
              <?php echo $rows['medName']; ?>
            </td>
            <td id="pid">
              <?php echo $rows['dose_form']; ?>
            </td>
            <td id="pid">
              <?php echo $rows['date_added']; ?>
            </td>
          </tr>
          <?php
                           };
